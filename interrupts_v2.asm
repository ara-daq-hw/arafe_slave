...
TIMER1_TX_ISR:
	...
	; It was set. We need to clear P1DIR bit 5 (turn OFF transmitter)
...
timer1_tx_isr_clear:
	...
	; No, so that wasn't the stop bit. Set P1DIR (turn ON transmitter)
	bis.b	#(BIT4), &P1SEL
	; Continue on.
	reti
timer1_tx_isr_done:
	; turn off the timer
	mov.w 	#(TASSEL_2 + ID_3 + TACLR + MC_0), &TA1CTL
